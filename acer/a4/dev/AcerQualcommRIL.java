...
public class AcerQualcommRIL extends QualcommSharedRIL implements CommandsInterface {
    protected int mPinState;
    boolean RILJ_LOGV = true;
    boolean RILJ_LOGD = true;

    public AcerQualcommRIL(Context context, int networkMode, int cdmaSubscription) {
